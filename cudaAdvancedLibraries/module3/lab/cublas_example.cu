...
/* Documentation: https://docs.nvidia.com/cuda/archive/12.3.1/cublas/index.html#introduction */
...
int  main (int argc, char** argv) {
    cublasStatus status; // cublas has its own status type - https://docs.altimesh.com/api/Hybridizer.Runtime.CUDAImports.cublasStatus_t.html
    int i,j;
    ...
    // define pointers to device (GPU)
    float* AA; float* BB; float* CC;

    /*ALLOCATE ON THE DEVICE and assign to the previously defined pointers to have a handle to the GPU memory */
